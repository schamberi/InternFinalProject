...
class StandartDataMappingVersionTwo(APIView):
    template_name = 'uploadButon.html'
    secondary_template = 'company_data.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Retrieve all companies after creation
            companies = Company.objects.all()

            # Pass the companies to the template for rendering
            return render(request, self.secondary_template, {'companies': companies})
